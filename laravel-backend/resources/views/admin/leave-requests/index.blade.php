...
<div class="space-y-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div class="stat-card">
            ...
            <p class="mt-2 text-3xl font-bold text-gray-900">{{ $counts['all'] }}</p>
        </div>
    </div>
                ...
                <div class="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-5">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 text-sm">
                            <div>
                                <p class="text-xs text-gray-400 font-semibold uppercase">Jenis</p>
                                <p class="mt-1 font-semibold text-gray-800">{{ $requestItem->leave_type }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-semibold uppercase">Durasi</p>
                                <p class="mt-1 font-semibold text-gray-800">{{ $requestItem->is_half_day ? 'Setengah hari' : $requestItem->duration_days . ' hari' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-400 font-semibold uppercase">Diajukan</p>
                                <p class="mt-1 font-semibold text-gray-800">{{ $requestItem->created_at->format('d M Y, H:i') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 grid grid-cols-1 lg:grid-cols-4 gap-3">
                            ...
                            <div class="rounded-xl bg-gray-50 p-4">
                                <p class="text-xs font-semibold uppercase text-gray-400 mb-1">Kontak</p>
                                <p class="text-sm text-gray-700">{{ $requestItem->contact_during_leave ?: '-' }}</p>
                            </div>
                            <div class="rounded-xl bg-gray-50 p-4">
                                <p class="text-xs font-semibold uppercase text-gray-400 mb-1">Serah Terima</p>
                                <p class="text-sm text-gray-700 whitespace-pre-line">{{ $requestItem->handover_note ?: '-' }}</p>
                            </div>
                            <div class="rounded-xl bg-gray-50 p-4">
